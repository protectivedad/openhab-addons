...
public class DeviceData extends HoneywellAbstractData {
    ...
    public Number getHumidity() {
        return rawObject.getNumber("indoorHumidity");
    }

    public Number getTemperature() {
        return rawObject.getNumber("indoorTemperature");
    }

    public Number getHeatSetpoint() {
        return changeableValues.getNumber("heatSetpoint");
    }
    ...
    public Number getCoolSetpoint() {
        return changeableValues.getNumber("coolSetpoint");
    }
