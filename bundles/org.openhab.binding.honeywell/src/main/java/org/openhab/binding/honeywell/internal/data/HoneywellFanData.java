...
/**
 * The {@link HoneywellFanData} defines the Honeywell api changeableValues data and acts as the gatekeeper
...
public class HoneywellFanData extends HoneywellAbstractData {
    ...
    public static final ChannelTypeUID FANMODE_TYPE = new ChannelTypeUID(BINDING_ID, FANMODE);
    ...
    public String setState(String cmdString) {
        if (!isValid()) {
            return "Invalid fan data, refusing to set: mode";
        }
    ...
    public String toJson() throws IOException {
        if (!isValid()) {
            throw new IOException("Fan object is empty");
        }
        try {
